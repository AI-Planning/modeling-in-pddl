...
(define (domain music-v5)
    ...
    ; Special version of the play-note action that only plays the tonic note. Differences:
    ; - at the start, we should confirm the pitch is the tonic of the chord
    ; - it makes (playing-tonic) true at the start and false at the end
    ; - it's called play-tonic-note and not play-note
    ; TODO: Your turn to copy & paste! Then make the changes above...
    ...
    (:durative-action progress
        ...
        :condition (and
            ...
            ; NOTE: Check it out! Not only will this force the tonic to be
            ;       played at the start of the chord, but it will also make
            ;       sure that the note starts right away.
